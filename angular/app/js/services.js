...
angular.module('xenon.services', []).
	service('$menuItems', function()
	{
		...
		{
			var layouts      = this.addItem('Layout & Skins',	'/app/dashboard-variant-1',	'linecons-database', 'modal-5');
			var dashboard    = this.addItem('Dashboard', 		'/app/dashboard-variant-1', 			'fa-question', 'modal-6');
