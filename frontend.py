...
@app.route('/app/js/<path:path>')
def send_js(path):
	return send_from_directory('C:\\Users\\tyler1314371\\Desktop\\game\\HungerCraft\\angular\\app\\js', path)

@app.route('/assets/<path:path>')
def send_assets(path):
	return send_from_directory('C:\\Users\\tyler1314371\\Desktop\\game\\HungerCraft\\angular\\assets', path)
